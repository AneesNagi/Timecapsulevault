          ...
          <VStack spacing={6} align="stretch">
            ...
            >
              ...
              <Text color={mutedTextColor} fontSize="lg">
                Your new crypto wallet is ready to use on {getNetworkName()}
              </Text>
            </MotionBox>
            ...
            <Alert status="info" borderRadius="lg" variant="left-accent">
              ...
              <AlertDescription>
                ...
                <Text fontSize="sm">
                  To start creating secure vaults, you'll need to fund your wallet with some {getCurrencyName()}. 
              ...
              <CardBody p={4}>
                <VStack spacing={3}>
                  <HStack justify="space-between" w="full">
                    ...
                    <Badge colorScheme="purple" variant="subtle">{getNetworkName()}</Badge>
                  </HStack>
          ...
          <VStack spacing={6} align="stretch">
            ...
            >
              ...
              <Text color={mutedTextColor}>
                Get testnet {getCurrencyName()} to start using your wallet
              </Text>
            </MotionBox>
            ...
            <Alert status="warning" borderRadius="lg" variant="left-accent">
              ...
              <AlertDescription>
                ...
                <Text fontSize="sm">
                  This is a testnet application. Use only test {getCurrencyName()} from faucets - never send real {getCurrencyName()}!
                </Text>
              </AlertDescription>
            </Alert>
              ...
              <Box w="full" p={4} bg="green.50" borderRadius="lg" border="1px" borderColor="green.200">
                <VStack spacing={3} align="start">
                  <HStack>
                    ...
                    <Text fontSize="sm" fontWeight="bold">Get test {getCurrencyName()} from faucet</Text>
                  </HStack>
                  <Button
                  ...
                  <Text fontSize="xs" color="green.700">
                    Paste your address and request test {getCurrencyName()} (usually takes 1-2 minutes)
                  </Text>
                </VStack>
              </Box>
