...
export const WalletDetail = () => {
  ...
  return (
    <Box 
      minH="100vh" 
      bg="#181a20"
      style={{ background: 'linear-gradient(135deg, #181a20 0%, #232526 60%, #3a1c71 100%)' }}
      py={8}
    >
      <Container maxW="7xl">
          ...
          >
            <VStack spacing={4} textAlign="center">
              <HStack spacing={3}>
                ...
                <Heading size="xl" color="#ffffff">Wallet Details</Heading>
              </HStack>
                ...
                <CardBody p={6}>
                  ...
                  <Box>
                      <HStack mb={2} justify="space-between">
                        <Text fontSize="sm" color="#a0a0a0" fontWeight="medium">Address</Text>
                  ...
                  <Box>
                      <HStack mb={2} justify="space-between">
                        <Text fontSize="sm" color="#a0a0a0" fontWeight="medium">Balance</Text>
                  ...
                  <Box alignSelf="center" pt={2}>
                      <VStack spacing={3}>
                        <Box p={4} bg="rgba(35, 37, 38, 0.9)" borderRadius="lg" boxShadow="md">
                    <QRCodeSVG
                    ...
                    />
                                                ...
                                                <Text fontSize="xs" color="#a0a0a0" textAlign="center">
        ...
        <GridItem>
          ...
          <Tabs variant="enclosed" colorScheme="purple" isLazy>
                              <TabList bg="rgba(35, 37, 38, 0.9)" borderRadius="lg" p={1} boxShadow="md">
                <Tab 
            ...
            <TabPanels>
                <TabPanel px={0} pt={6}>
                  <Card bg="rgba(35, 37, 38, 0.9)" borderColor="#4a5568" borderRadius="xl" boxShadow="lg">
                  <CardHeader>
                      <HStack spacing={3}>
                  ...
                  <CardBody>
                      ...
                      <FormControl isRequired>
                          <FormLabel color="#e6e6e6" fontWeight="medium">Recipient Address</FormLabel>
                        <Input
                          value={recipient}
                        ...
                        />
                                                      <FormHelperText color="#a0a0a0">Enter the full wallet address</FormHelperText>
                      </FormControl>
                      ...
                      >
                          <HStack justifyContent="space-between" mb={4}>
                            <HStack spacing={2}>
                              ...
                              <Heading size="sm" color="#ffffff">Transaction Details</Heading>
                            </HStack>
                        ...
                        {gasEstimate ? (
                            ...
                            <HStack justify="space-between">
                                <VStack align="start" spacing={1}>
                                  <Text fontSize="sm" color="#a0a0a0" fontWeight="medium">Network Fee:</Text>
